...
def createResponse(query, latitude, longitude, coordCheck):
    ...
    for index, restaurant in topRecommendedRestaurants.iterrows():
        ...
        response += f"<br>{counter})  <b>{restaurant['name']}</b> is a great option. It has a rating of <b>{restaurant['rating']}</b> and a total of <b>{restaurant['review_number']}</b> reviews!<br>The address is <b>{address}</b>."
        counter += 1
